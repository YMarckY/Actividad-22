...
<section class="hero is-primary">
 ...
 <form method="post" action="guardar.php">
        <div class="field">
          ...
          <div class="control">
            <input name="nombre" class="input" type="text" placeholder="Tu nombre">
          </div>
        </div>
         ...
         <div class="field">
          ...
          <div class="control">
            <input name="login"  class="input" type="text" placeholder="Tu login">
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="control">
            <input name="correo" class="input" type="text" placeholder="Tu correo">
          </div>
        </div>
        ...
        <div class="field is-grouped">
          <div class="g">
            <button type="submit" class="button is-link" style="background:#09dab7;">Guardar</button>
          </div>
        </form>
        </div>
    </div>
